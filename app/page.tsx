                    ...
                    <form onSubmit={handleSubmit} className='flex flex-grid place-content-center'>
                        <div className="mb-4 min-w-6xl">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0c3c6f]"
                                placeholder="0x..."
                            />
                        </div>
                        <button
                            type="submit"
                            className="self-center max-h-12 bg-[#0c3c6f] text-white py-1 px-2 mt-3 ml-2 rounded-lg hover:bg-[#56b9d5] transition-colors cursor-pointer"
                        >
